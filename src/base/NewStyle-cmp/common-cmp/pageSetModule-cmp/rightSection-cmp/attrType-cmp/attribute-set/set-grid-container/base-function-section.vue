<!--
    User:
    Date:
    功能: grid-container: function-section 设置  组件
-->
<style lang="stylus" rel="stylesheet/stylus" scoped>
@import "../../common-set-style.styl";
.grid-container-function-section-cmp {

}
</style>
<template>
    <div class="grid-container-function-section-cmp">
        grid-container: function-section 设置  组件
    </div>
</template>
