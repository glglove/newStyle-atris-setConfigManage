<!--
    User:
    Date:
    功能: showingcomponents: linkbox 设置  组件
-->
<style lang="stylus" rel="stylesheet/stylus" scoped>
@import "../../common-set-style.styl";
.showingcomponents-linkbox-cmp {

}
</style>
<template>
    <div class="showingcomponents-linkbox-cmp">
        <!-- showingcomponents: linkbox 设置  组件 -->
        ...
        <ul class="common-listWrap">
            ...
            <el-form-item>
                <li class="common-item u-f-ac">
                    <span class="common-label ellipsis1">单行截断</span>
                    <el-switch
                        class="u-f-s1"
                        size="mini"
                        :inactive-value="1"
