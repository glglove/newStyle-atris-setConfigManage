  ...
  export default {
    ...
    methods: {
      ...
      handleCheckChange(data,checked, indeterminate){
        ...
        // this.currentTit = data.UserGroupName
        this.currentClickObj = data
        // this.currentClickNodeUserArr = data.Users
        // this.showUserDailog = true
        if(data.IsUser){
          // 点击的是 用户
          this.$emit("userNodeClick", data, checked)
        }else {
          this.$emit("treeNodeClick", data, checked)          
          console.log("点击的是非用户", data.UserGroupName)
        }
      },
      //节点被点击
      ...
      handleCheckAllChange(val) {
        ...
        // let checkedObj = val ? this.currentClickNodeUserArr : [];
