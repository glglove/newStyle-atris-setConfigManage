...
<template>
    <div class="middleCmp">
                ...
                >
                    <transition-group>
                        ...
                        >
                            ...
                            <div 
                                :class="['cmp-item', 
                                        index == currentClickItemObjIndex ? 'is-active': '',
                                        obj.isSystemAdd ==1 ? 'isSytem': ''
                                    ]" 
        ...
        <div class="showSysFieldDialog">
            <el-dialog
                v-if="showSysFieldDialog"
                title="新增系统字段"
                :visible.sync="showSysFieldDialog"
                append-to-body
            ...
            >
                <div slot="title" class="header-title">
                    <div class="u-f-jsb u-f-ajc topTitleNav">
                        <span class="title-age">选择器</span>
                        <!-- <div class="u-f-ajc">
                            <save-footer 
                                saveBtnSize="mini"
                                :isCancel="false"
                                @save="saveAddCommonSelector"
                                @cancel="cancelAddCommonSelector"
                            ></save-footer> 
                        </div> -->
                    </div>
                </div>    
                ...
                <common-selector-cmp
                    ref="commonSelectorCmpRef"
                    propType="choseDBunicode"
                    :objP = 'objP'
                    @emitSelectorChecked="emitSelectorChecked"
                >
                </common-selector-cmp>
            </el-dialog>
        </div>
...
<script type="text/ecmascript-6">
    ...
    export default {
        ...
        methods: {
            ...
            showCommonSelector(){
                this.showSysFieldDialog = true
            },
            hideCommonSelector(){
                this.showSysFieldDialog = false
            },            
            // 批量添加 系统字段
            batchAddSysFields(){
                this.showCommonSelector()
            },
            emitSelectorChecked(selectSystemControlArr){
                debugger
                this.hideCommonSelector()
